...
function copy(array){ // I'm putting array as a paramater it could be anything
 return  [...array];// returns a copy of the array!!
 
}    
console.log(copy(originalFlavors)) // the argument (Original Flavours) is inputting as "array"
...
function is31Flavors(array){ //1. array as a parameter 
  if (array.length === 31 ){ //checking if the the array is === 31
    return true;} // the computer return true 
    else{
      return false;//if its not 31 return false 
    }
  }
  
console.log(is31Flavors(originalFlavors)); //remember to put a semi colon here!
...
function addFlavor(array , newflavor){// array and newflavor as paramaters
 array.unshift(newflavor);// .unshift adds an item to the beggining of the array 
 return array;

}
console.log(addFlavor(originalFlavors , 'Rainbow Sherbert'));// rainbow sherbert will be added to the start of the array
